...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --daemon', 'Make bitcore-nodejs-dash a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bitcore-nodejs-dash create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bitcore-nodejs-dash add wallet-service');
      console.log('    $ bitcore-nodejs-dash add insight-api-dash');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bitcore-nodejs-dash remove wallet-service');
      console.log('    $ bitcore-nodejs-dash remove insight-api');
      console.log();
    });
